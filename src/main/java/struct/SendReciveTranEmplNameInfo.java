 ...
 *
 */
public class SendReciveTranEmplNameInfo {
	//送受信区分
	...
	//最終登録状況名
	private String last_ins_status_name;
	...
	public String getLast_ins_status_name() {
		return last_ins_status_name;
	}

	public void setLast_ins_status_name(String last_ins_status_name) {
		this.last_ins_status_name = last_ins_status_name;
	}
	...
	public void setOperation_color(String operation_color) {
		this.operation_color = operation_color;
	}
